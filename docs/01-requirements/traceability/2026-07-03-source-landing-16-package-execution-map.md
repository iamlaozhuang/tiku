...
| 10  | `org-auth-overlap-closure-source-landing-2026-07-03`             | closed         | `UX-REQ-01`, `UX-REQ-02`, `G09`, `CT-REQ-004`, `CT-REQ-008`                                                 | Explicit closure actions for overlap and atomic-scope presentation within existing no-schema boundary; any schema work remains separate.                                         |
| 11  | `employee-import-password-source-landing-2026-07-03`             | closed         | `UX-REQ-05`, `G03`, `CT-REQ-011`, `CT-REQ-051`, `D05`                                                       | Target node selection, preview, optional generated password, one-time distribution window, and no authorization columns.                                                         |
| 12  | `employee-transfer-session-source-landing-2026-07-03`            | closed         | `G04`, `CT-REQ-013`, `D05`                                                                                  | Landed transfer/session review, quota-blocked target rows, old-organization snapshot copy, in-progress blocking, and reset-session copy.                                         |
| 13  | `learner-core-experience-source-landing-2026-07-03`              | closed         | `UX-REQ-15`, `UX-REQ-16`, `G12`, `CT-REQ-033` through `CT-REQ-035`, `D13`, `D14`                            | Registration/session/redeem/profile plus practice, `mock_exam`, report, and objective-only mistake book UX.                                                                      |
| 14  | `learner-ai-context-source-landing-2026-07-03`                   | closed         | `UX-REQ-12`, `G13`, `CT-REQ-033`, `D13`                                                                     | Landed explicit learner AI context selector, personal-default quota ownership, organization quota only after explicit selection, and preserved history/retry/unavailable states. |
