...
| `docs/01-requirements/advanced-edition/modules/06-ops-authorization-quota.md`                                  | Operations authorization/status and remaining-seat summaries that organization UX may reference safely; enterprise AI quota consumption summaries remain hidden from organization admins. |
