# 2026-06-30 Terminal Active Queue Archive Index Cleanup Audit
...
- The cleanup moved only the six named pre-materialization terminal archive candidates.
...
- The active queue retained the prior project-state current task, current cleanup task, blocked staging task, and terminal recovery window.
