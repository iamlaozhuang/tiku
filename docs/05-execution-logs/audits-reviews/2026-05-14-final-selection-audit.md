...
| AI SDK | Vercel AI SDK         | Vercel AI SDK _(不变)_         | —                                                  |
| UI     | shadcn/ui + Tailwind  | shadcn/ui + Tailwind _(不变)_  | —                                                  |
| 数据库 | PostgreSQL + pgvector | PostgreSQL + pgvector _(不变)_ | —                                                  |
| 语言   | 100% TypeScript       | 100% TypeScript _(不变)_       | —                                                  |
