...
- Merge target: `master`
- Source branch: `codex/phase-12-secret-env-provider-approval-plan`
- Feature commit: `be6463b docs(ai): add provider secret approval runbook`
- Initial merge commit before evidence amend: `4f98fc8 merge: add phase 12 provider approval runbook`
- Master verification:
...
- Post-merge forbidden scope check:
  - No source/package/lockfile/schema/migration/script changes.
