...
| `git diff --check`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | pass                                                                                         |
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Get-TikuProjectStatus.ps1`                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | pass; no pending task; active nonterminal 4; archive candidates 17; Cost Calibration blocked |
