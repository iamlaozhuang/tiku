...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId batch-242-organization-training-paper-and-mock-exam-context-usage-without-ex`                                                                                                                                                                                                    | pending final stage | To be run after closeout state is recorded and commit hash is available. |
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2PrePushReadiness.ps1 -TaskId batch-242-organization-training-paper-and-mock-exam-context-usage-without-ex`                                                                                                                                                                                                           | pending final stage | To be run before pushing `origin/master`.                                |
