...
| `Test-ModuleRunV2AutomationStartupReadiness.ps1 -SkipAutomationRegistrationCheck -AllowProtectedBranch`                                        | blocked pre-commit dirty tree; final clean rerun required | After phase85 was marked closed, the command correctly stopped on `HARD_BLOCK_PRIMARY_AUTOMATION_REPOSITORY_DIRTY`; rerun after local commit is required. |
