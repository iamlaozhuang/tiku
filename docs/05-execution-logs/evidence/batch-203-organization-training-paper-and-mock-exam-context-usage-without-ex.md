...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId batch-203-organization-training-paper-and-mock-exam-context-usage-without-ex`                                                                                          | pending | To run after the implementation commit hash is available and recorded.     |
