...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId batch-225-organization-analytics-privacy-preserving-employee-statistics`                                                                                                                                                                                        | pending | Pending after validation commit and closeout update. |
