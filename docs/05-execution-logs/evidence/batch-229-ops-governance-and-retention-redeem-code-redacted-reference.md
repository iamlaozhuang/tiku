...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId batch-229-ops-governance-and-retention-redeem-code-redacted-reference`                                                                                                                                                                                                | pending | Pending after validation commit and closeout update. |
