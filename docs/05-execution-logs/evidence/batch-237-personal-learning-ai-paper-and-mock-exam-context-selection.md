...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId batch-237-personal-learning-ai-paper-and-mock-exam-context-selection`                                                                                                                                                                                                    | pending final stage | To be run after the first local closeout commit hash is recorded.  |
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2PrePushReadiness.ps1 -TaskId batch-237-personal-learning-ai-paper-and-mock-exam-context-selection`                                                                                                                                                                                                           | pending final stage | To be run before pushing `origin/master`.                          |
