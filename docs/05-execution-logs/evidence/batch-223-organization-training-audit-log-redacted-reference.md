...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId batch-223-organization-training-audit-log-redacted-reference`                                                                                                                                                                                      | pending | Pending after validation commit and closeout update. |
