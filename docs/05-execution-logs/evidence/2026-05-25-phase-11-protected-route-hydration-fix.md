...
| `npm.cmd run test:e2e`                                                                                                              | pass   | 15/15 passed using 1 worker; no hydration mismatch log was emitted in the rerun. A post-merge master gate exposed benign Next.js chunk aborts during route transition; the E2E transition-abort allowlist was narrowed to that asset path and rerun. |
