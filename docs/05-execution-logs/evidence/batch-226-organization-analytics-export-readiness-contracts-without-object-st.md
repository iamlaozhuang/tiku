...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId batch-226-organization-analytics-export-readiness-contracts-without-object-st`                                                                                                                                                                                        | pending | Pending after validation commit and closeout update. |
