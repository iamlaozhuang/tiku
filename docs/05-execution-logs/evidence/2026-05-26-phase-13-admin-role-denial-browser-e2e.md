...
**Feature commit:** `822f958 test(auth): cover admin role denial`
...
- Merged `codex/phase-13-admin-role-denial-browser-e2e` into `master` with `--no-ff`.
- Post-merge `npm.cmd run test:e2e` passed: 24 Chromium tests.
