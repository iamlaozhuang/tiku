...
- Implementation commit: `c83f462 docs(agent): add evidence summary template`.
- Local merge commit: `d7f2ae7 merge: phase 15 evidence summary template`.
...
- Branch cleanup target: delete `codex/phase-15-evidence-summary-template` after push.
