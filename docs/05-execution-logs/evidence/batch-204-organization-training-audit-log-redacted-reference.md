...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId batch-204-organization-training-audit-log-redacted-reference`                                                                                          | pending | To run after the implementation commit hash is available and recorded.     |
