...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId batch-240-organization-training-organization-admin-training-draft-publish-ta`                                                                                                                                                                                                    | pending final stage | To be run after closeout state is recorded.                                                                   |
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2PrePushReadiness.ps1 -TaskId batch-240-organization-training-organization-admin-training-draft-publish-ta`                                                                                                                                                                                                           | pending final stage | To be run before pushing `origin/master`.                                                                     |
