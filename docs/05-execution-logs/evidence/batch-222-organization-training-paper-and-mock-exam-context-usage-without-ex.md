...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId batch-222-organization-training-paper-and-mock-exam-context-usage-without-ex`                                                                                                                                                                                      | pending | Pending after validation commit and closeout update. |
