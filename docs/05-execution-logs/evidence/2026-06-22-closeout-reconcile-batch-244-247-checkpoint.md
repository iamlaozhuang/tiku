...
| Post-closeout reconcile | `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Invoke-ModuleRunV2PostCloseoutStateReconcile.ps1 -TaskId closeout-reconcile-batch-244-247-checkpoint`                                                                                                                                                                                                                                      | to rerun after first local closeout commit, because the script requires a clean Git worktree and closed currentTask |
