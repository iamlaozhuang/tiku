...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId module-run-v2-cross-role-local-flow-planning`                                                                                                                                                                                                                                             | pending | Will run during closeout.                                                                                                 |
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2PrePushReadiness.ps1 -TaskId module-run-v2-cross-role-local-flow-planning`                                                                                                                                                                                                                                                    | pending | Will run before merge/push.                                                                                               |
...
- nextModuleRunCandidate: none selected by this packet; after closeout, return to local next-action diagnostics for the
