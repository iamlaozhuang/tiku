...
- Merge target: `master`
- Source branch: `codex/phase-12-role-scenario-experience-registration`
- Feature commit: `82b7ac3 docs(agent): register role scenario experience scan`
- Initial merge commit before evidence amend: `5fff6ab merge: register phase 12 role scenario experience scan`
- Master verification:
