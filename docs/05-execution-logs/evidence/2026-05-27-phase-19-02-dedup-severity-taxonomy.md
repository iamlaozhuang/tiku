...
- Implementation commit: `c2f5cde0ab67a985dd2533218aa6331fe05300c0`.
- Merge target: `master`.
- Merge result: fast-forward merge from `codex/phase-19-02-dedup-severity-taxonomy` into `master`.
