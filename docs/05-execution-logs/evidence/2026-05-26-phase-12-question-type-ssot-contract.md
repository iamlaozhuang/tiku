...
| --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------------ | ------------- | ----------- | ------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | --------------------------------------------------------------------------------------------- |
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-TaskClaimReadiness.ps1 -TaskId phase-12-question-type-ssot-contract` | PASS         | Task was claimable on `codex/phase-12-question-type-ssot-contract`; dependency `phase-12-question-type-task-registration` was closed. |
| `rg -n "single_choice                                                                                                                                     | multi_choice | true_false                                                                                                                            | fill_blank | short_answer | case_analysis | calculation | question_type | 案例分析 | 计算题" docs\01-requirements\modules\02-question-paper.md docs\03-standards\glossary.yaml docs\02-architecture\interfaces\question-paper-contract.md` | PASS | Requirements and glossary already listed seven values; contract needed two additional values. |
...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-GitCompletionReadiness.ps1 -BaseBranch master`                       | PASS         | Inventory completed; changes were limited to contract, queue/state/task-plan/evidence.                                                |
