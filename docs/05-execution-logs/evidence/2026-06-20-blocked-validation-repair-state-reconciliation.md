...
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId blocked-validation-repair-state-reconciliation-2026-06-20`                                                                                                                                                                                                                                      | pending | Will run during closeout.                                                                                             |
| `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2PrePushReadiness.ps1 -TaskId blocked-validation-repair-state-reconciliation-2026-06-20`                                                                                                                                                                                                                                             | pending | Will run before merge/push.                                                                                           |
...
- nextModuleRunCandidate: personal AI auth/session repair packet, if reconciliation gates pass.
