# Task Plan: batch-237-personal-learning-ai-paper-and-mock-exam-context-selection

## Scope

- Module: `personal-learning-ai`
- Branch: `codex/batch-237-personal-learning-ai-context-selection`
- Task: validate paper and `mock_exam` context selection for personal AI generation request contracts.
...
- Prefer no source change if `personal-ai-generation-request-context-service` already validates the required contract.
- Run the focused unit target first: `src/server/services/personal-ai-generation-request-context-service.test.ts`.
