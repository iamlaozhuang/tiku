...
- [x] Keep historical startup recovery WIP semantics aligned with P1 active statuses during `ready_for_closeout`, using bounded direct-item parsing and top-level contamination fixtures.
