# Batch 231 Ops Governance Local Recovery Expired Hidden Boundary Plan

## Task

- Task id: `batch-231-ops-governance-and-retention-local-recovery-and-expired-hidden-boundary-c`.
- Branch: `codex/batch-231-ops-governance-recovery-boundary`.
- Target closure item: local recovery and expired-hidden boundary contracts.
...
- `docs/05-execution-logs/task-plans/2026-06-20-batch-231-ops-governance-local-recovery-expired-hidden-boundary.md`.
- `docs/05-execution-logs/evidence/batch-231-ops-governance-and-retention-local-recovery-and-expired-hidden-boundary-c.md`.
- `docs/05-execution-logs/audits-reviews/batch-231-ops-governance-and-retention-local-recovery-and-expired-hidden-boundary-c.md`.
...
- `git diff --check`
- `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2PreCommitHardening.ps1 -TaskId batch-231-ops-governance-and-retention-local-recovery-and-expired-hidden-boundary-c`
- `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2ModuleCloseoutReadiness.ps1 -TaskId batch-231-ops-governance-and-retention-local-recovery-and-expired-hidden-boundary-c`
- `powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\agent-system\Test-ModuleRunV2PrePushReadiness.ps1 -TaskId batch-231-ops-governance-and-retention-local-recovery-and-expired-hidden-boundary-c`
