...
| 3        | `0704-rag-citation-smoke`        | pending       | `knowledge_node`, resource, citation, and `evidence_status` propagation in AI/RAG surfaces.                                                   | Prefer contract/source/evidence-backed smoke; Provider-enabled execution remains blocked.         |
