...
| Scoped Prettier check and `git diff --check` pass                                                                                                                                 | pending final gate |
| Module Run v2 pre-commit, closeout, and pre-push gates pass                                                                                                                       | pending final gate |
...
| Task is committed, fast-forward merged to `master`, pushed to `origin/master`, and short branch is cleaned up                                                                     | pending closeout   |
